...
public:
	...
	void AcceptCommand(const apl::AnalogRead& arType, size_t aIndex, int aSequence, IResponseAcceptor* apRspAcceptor);
	...
	void Read(apl::AnalogRead& arType, CommandData& arData);
...
protected:
	...
	std::queue< apl::AnalogRead > mAnalogReadQueue;
